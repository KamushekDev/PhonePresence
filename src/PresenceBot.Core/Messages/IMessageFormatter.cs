...
public interface IMessageFormatter
{
    ...
    string GetBecameActiveNotification(DateTimeOffset lastActiveTimestamp, TimeSpan inactivityTimeSpan);
    string GetFirstAppearanceNotification(string clientIdentity);
}